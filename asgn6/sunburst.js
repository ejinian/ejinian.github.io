...
d3.json('miserables2.json', (error, root) => {
    ...
    const newSlice = slice.enter()
        ...
        .on("mouseover", function (d) {
            ...
            tooltip.style("opacity", 1).html(
                '<b>' + d.data.treeDataItemData.name + '</b>' + '<br>' +
                'Value: ' + d.value + '<br>' +
                'Children: ' + d.children.length + '<br>' +
                'Color: ' + d.data.treeDataItemData.fill + '<br>' +
                'Depth: ' + d.depth + '<br>' +
                'ID: ' + d.data.treeDataItemData.id + '<br>'
            );
        })
        // lock tooltip to mouse
        ...
        .on("mouseout", function (d) {
            // d3.select(this).attr("fill", color((d.children ? d : d.parent).data.treeDataItemData.name));
    ...
    newSlice.append('path')
        .text(d => d.data.treeDataItemData.name)
        .attr('class', 'main-arc')
        .style('fill', d => color((d.children ? d : d.parent).data.treeDataItemData.name))
        .attr('d', arc);
